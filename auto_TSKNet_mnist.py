...
testset = mindspore.dataset.FashionMNIST(root='./data', train=False, download=True)
...
for NumRule1 in rules1:
    for NumFilter1 in NumFilters1:
        ...
        for train_index, test_index in kf.split(Datas.T):
            ...
            DeepTSK['NumRules'] = [NumRule1, NumRule1]
            DeepTSK['NumStages'] = 2
            DeepTSK['PatchSize'] = [7, 7]
            DeepTSK['NumFilters'] = [NumFilter1, NumFilter1]
        ...
        if acc_te_mean > best_acc_te:
            ...
            mindspore.save(best_result, 'best_result/best_result_mnist_2stage_filters.pth')
            best_acc_te = acc_te_mean

mindspore.save(all_result, 'best_result/all_result_mnist_2stage_filters.pth')
